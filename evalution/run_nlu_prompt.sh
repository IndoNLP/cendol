...
# Zero-Shot mT0 Eng
CUDA_VISIBLE_DEVICES=0 python main_nlu_prompt_batch.py eng bigscience/mt0-small 32 &
CUDA_VISIBLE_DEVICES=1 python main_nlu_prompt_batch.py eng bigscience/mt0-base 16 &
CUDA_VISIBLE_DEVICES=2 python main_nlu_prompt_batch.py eng bigscience/mt0-large 8 &
...
CUDA_VISIBLE_DEVICES=0 python main_nlu_prompt_batch.py eng bigscience/bloomz-560m 16 &
CUDA_VISIBLE_DEVICES=1 python main_nlu_prompt_batch.py eng bigscience/bloomz-1b1 12 &
CUDA_VISIBLE_DEVICES=2 python main_nlu_prompt_batch.py eng bigscience/bloomz-1b7 8 &
CUDA_VISIBLE_DEVICES=3 python main_nlu_prompt_batch.py eng bigscience/bloomz-3b 4 &
