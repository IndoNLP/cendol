...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    ...
    elif "indonlp/nusa_t2t" in dataset_name:
        # TODO: Avoid hardcoded constants
        return raw_datasets.NusaT2TDataset(output_path, seed, local_rank, dataset_name, 
                               use_auth_token=True, sample_size=6005000, val_set_size=5000)
