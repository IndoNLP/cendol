...
HF_HOME=/home/users/nus/hlovenia/.cache/huggingface
HUGGINGFACE_HUB_CACHE=/home/users/nus/hlovenia/.cache/huggingface/hub
TRANSFORMERS_CACHE=/home/users/nus/hlovenia/.cache/huggingface/hub
HF_DATASETS_CACHE=/home/users/nus/hlovenia/.cache/huggingface/datasets
...
torchrun --nproc_per_node=4 --master_port=1234 finetune_seq2seq.py \
    ...
    --run_name cendol-mt5-${model_size} | tee ./log/indo-mt5-small.log
...
#     --wandb_project cendol \
#     --load_in_8bit True \
#     --run_name cendol-mt5-${model_size} | tee ./log/indo-mt5-xxl.log
