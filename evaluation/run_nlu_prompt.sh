...
# CUDA_VISIBLE_DEVICES=0 python main_nlu_prompt_batch.py ind indonlp/cendol-sealion-7b 16
# CUDA_VISIBLE_DEVICES=0 python main_nlu_prompt_batch.py eng indonlp/cendol-sealion-7b 16

# Zero-Shot Cendol V2 SEA-LION 7B Ind & Eng
CUDA_VISIBLE_DEVICES=0 python main_nlu_prompt_batch.py ind indonlp/cendol-sealion-7b-chat 4 &
CUDA_VISIBLE_DEVICES=3 python main_nlu_prompt_batch.py eng indonlp/cendol-sealion-7b-chat 4 &