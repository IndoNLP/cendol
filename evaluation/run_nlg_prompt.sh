...
# CUDA_VISIBLE_DEVICES=1 python main_nlg_prompt_batch.py ind indonlp/cendol-sealion-7b 0 8
# CUDA_VISIBLE_DEVICES=1 python main_nlg_prompt_batch.py eng indonlp/cendol-sealion-7b 0 8

# Zero-Shot Cendol V1 SEA-LION 7B Ind & Eng
CUDA_VISIBLE_DEVICES=1 python main_nlg_prompt_batch.py ind indonlp/cendol-sealion-7b-chat 0 8 &
CUDA_VISIBLE_DEVICES=2 python main_nlg_prompt_batch.py eng indonlp/cendol-sealion-7b-chat 0 8 &