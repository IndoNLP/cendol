...
# Zero-Shot Bactrian-X with Bloom 7B Ind
CUDA_VISIBLE_DEVICES=0 python main_nlg_prompt_batch.py eng bigscience/bloom-7b1---MBZUAI/bactrian-x-bloom-7b1-lora 0 40
CUDA_VISIBLE_DEVICES=1 python main_nlg_prompt_batch.py eng bigscience/bloom-7b1---haonan-li/bactrian-id-bloom-7b1-lora 0 40
