...
if __name__ == '__main__':
    ...
    elif "bloom" in MODEL or "xglm" in MODEL or "gpt2" in MODEL or "sealion" in MODEL or "Merak" in MODEL or "SeaLLM" in MODEL or  "Llama" in MODEL:
        model = AutoModelForCausalLM.from_pretrained(MODEL, device_map="auto", load_in_8bit=True, trust_remote_code=True)
        if "sealion" in MODEL or  "Llama" in MODEL:
